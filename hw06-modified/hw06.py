...
class VendingMachine:
    ...
    def vend(self):
        if self.num_products <= 0:
            ...
            self.funds, self.num_products = 0, self.num_products - 1  # remember to update self.num_products
    ...
    def restock(self, num):
        self.num_products += num
        return f'Current {self.product} stock: {self.num_products}'
