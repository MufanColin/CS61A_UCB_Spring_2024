...
def yield_paths(t, value):
    ...
    # Mind-bending !!!
    if label(t) == value:
        yield [value]  # yields a list
    for b in branches(t):
        for x in yield_paths(b, value):  # x is a list, yield_paths(b, value) is a list of lists
            yield [label(t)] + x  # yields a list by doing list concatenation
